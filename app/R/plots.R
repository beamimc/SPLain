...
# Function: line plot for transcript comparison 
# ---------------------------------------------------------------

line_plot_txp_comparison  <- function(se, 
                                      prop, 
                                      txp_colors, 
                                      cd1,
                                      cd2 ){
  
  plot_data <- get_plot_data(se, prop, cd1, cd2)
...
# ---------------------------------------------------------------
barplot_meandifs <- function(mean_diffs_DTU, pvals,
                             txp_colors) {
